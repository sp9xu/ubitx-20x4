...
/*  printLineF(1, F("CECBT v0.25")); 
  ...
  {*/
    printLine(0, "\xE4\BitX 20x4 by VK3DAN"); 
    printLine(1, "80-10m Transceiver");
    printLine(2, "based on code from");
    printLine(3, "VU2ESE and KD8CEC");
 ...
 */
  ...
  EEPROM.put(USER_CALLSIGN_LEN, 6 + 0x80);           //WORD COUNT
  
  EEPROM.put(USER_CALLSIGN_DAT + 0, 'V');      //
  EEPROM.put(USER_CALLSIGN_DAT + 1, 'K');      //
  EEPROM.put(USER_CALLSIGN_DAT + 2, '3');      //
  EEPROM.put(USER_CALLSIGN_DAT + 3, 'D');      //
  EEPROM.put(USER_CALLSIGN_DAT + 4, 'A');      //
  EEPROM.put(USER_CALLSIGN_DAT + 5, 'N');      //
/*  EEPROM.put(USER_CALLSIGN_DAT + 6, '/');      //
  EEPROM.put(USER_CALLSIGN_DAT + 7, 'A');      //
  EEPROM.put(USER_CALLSIGN_DAT + 8, 'B');      //
  EEPROM.put(USER_CALLSIGN_DAT + 9, 'C');      //*/
}
/*  //CW QSO CALLSIGN
